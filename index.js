...
let rooms = [{
    roomId:"R1",
    seatsAvailable:"3",
    amenities:"Geysers,AC,Television",
    pricePerhr:"200"
}];
let bookings = [{
    customer: "Vijay",
    bookingDate: "20240925",
    startTime: "12:00pm",
    endTime: "11:59am",
    bookingID: "B1",
    roomId: "R1",
    status: "booked",
    booked_On: "17/09/2024"
}
];
let customers = [
    { name: 'Vijay',
...
// View all the Rooms and its details
...
// Number of times the user booked the room
...
app.listen(4000, ()=> console.log("Hall Booking API"));